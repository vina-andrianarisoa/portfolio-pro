                    ...
                    <div className="grid place-content-center rounded-xl lg:grid-cols-[2fr_1fr] gap-2 lg:pt-32">
                        ...
                        <div className="space-y-8 order-2 lg:order-1">
                            ...
                            <div className="space-y-3 lg:space-y-4">
                                ...
                                <p className="w-full text-sm text-center lg:text-left lg:text-base text-muted-foreground mx-auto lg:mx-0 max-w-md lg:max-w-lg px-4 lg:px-0">
                        ...
                        {/* Image/Profil */}
                        <div className="relative order-1 lg:order-2 pt-10 pb-5 lg:p-0">
